...
class FontTypeButton: UIButton {
    ...
    convenience init(fontType: ReaderModeFontType) {
        ...
        switch fontType {
        case .SansSerif:
            setTitle("Sans-serif", forState: UIControlState.Normal)
            let f = ReaderModeStyleViewControllerUX.ThemeTitleFontSansSerif
            titleLabel?.font = f
        case .Serif:
            setTitle("Serif", forState: UIControlState.Normal)
...
class ThemeButton: UIButton {
    ...
    convenience init(theme: ReaderModeTheme) {
        ...
        switch theme {
        case .Light:
            setTitle("Light", forState: .Normal)
        ...
        case .Sepia:
            setTitle("Sepia", forState: .Normal)
